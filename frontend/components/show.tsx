        ...
        <div className='bg-black text-white py-16 px-8 font-interText'>
            <div className='text-center max-w-2xl mx-auto mb-16'>
                ...
                <p className='text-lg leading-relaxed'>
                    Contribute your part or maximize your project's potential by leveraging integrated tools for strategic growth, efficient operations, and seamless collaboration.
                </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                <div className='space-y-8'>
                    <div>
                        ...
                        <h2 className='text-2xl font-interTextBold mb-2'>Assemble Your Dream Team</h2>
                        <p className='leading-relaxed'>
                            Seamlessly structure roles and release positions to find collaborators. Build a community around your project.
                        </p>
                    </div>
                    <div>
                ...
                <div className='space-y-8'>
                    <div>
                        ...
                        <h2 className='text-2xl font-interTextBold mb-2'>Project Management</h2>
                        <p className='leading-relaxed'>
                            Effectively manage your project with robust tooling, raise funds, and distribute tasks to the community.
                        </p>
                    </div>
                    <div>
