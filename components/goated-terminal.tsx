 ...
 ╚══╝╚══╝  ╚═════╝  ╚═════╝ ╚══════╝╚═════╝ ╚═╝  ╚═╝   ╚═╝   
    `}
                ...
                <div className="text-2xl">
                    Focus on <span className="text-blue-300 font-bold underline">Innovation</span>,
                </div>
                <div
                    className="mb-8 text-2xl"
                >
                    We&#39;ll <span className="bg-white text-black font-bold px-1">Automate</span> the rest!
                </div>
            </div>
            <div>
                <div>
